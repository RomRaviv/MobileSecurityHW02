...
public class Activity_Menu extends AppCompatActivity {
    private final int ID_LEN = 9;
    private MaterialButton btn_menu_start;
    public TextInputEditText edt_menu_id;
    ...
    private void initViews() {
        this.btn_menu_start.setOnClickListener(v -> {
            if(edt_menu_id.getText().toString().length() < ID_LEN){
                Toast.makeText(Activity_Menu.this, "ID length must be 9", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private void findViews() {
        this.btn_menu_start = (MaterialButton) findViewById(R.id.btn_menu_start);
        this.edt_menu_id = (TextInputEditText) findViewById(R.id.btn_menu_id);
    }
        ...
        new Thread() {
            public void run() {
                ...
                if (data != null) {
                    ...
                    activity_Menu.startGame(activity_Menu.edt_menu_id.getText().toString(), data);
                }
            }
        }.start();
    }
